...
class TripPlan(BaseModel):
    ...
    optimization_summary: Optional[str] = Field(default=None, description="区域聚类和路径优化摘要")
...
class TripPlanResponse(BaseModel):
    ...
    session_id: Optional[str] = Field(default=None, description="临时会话 ID")
...
class TripRevisionRequest(BaseModel):
    ...
    message: str = Field(..., min_length=1, description="用户追加的修改要求")
